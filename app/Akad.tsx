...
const CountdownSection = () => {
  return (
    <section className="relative w-full min-h-screen flex justify-center bg-sage text-white overflow-hidden">
      {/* Main content container */}
      <div className="relative z-10 w-full max-w-lg mx-auto flex flex-col items-center px-4 sm:px-6 md:px-8 py-6 sm:py-10 bg-white bg-opacity-10 backdrop-blur-md rounded-3xl border border-white border-opacity-20 shadow-2xl">
        
        {/* Title */}
        <div className="text-center mb-8 sm:mb-12">
          <h2 className="font-playfair text-2xl sm:text-3xl md:text-4xl text-brand-gold">
            Turut Mengundang
          </h2>
        </div>
      ...
      {/* Subtle background decorative elements */}
      <div className="absolute bottom-0 left-0 w-20 sm:w-32 h-20 sm:h-32 bg-white bg-opacity-5 rounded-full -mb-10 sm:-mb-16 -ml-10 sm:-ml-16"></div>
      <div className="absolute top-0 right-0 w-16 sm:w-24 h-16 sm:h-24 bg-white bg-opacity-5 rounded-full -mt-8 sm:-mt-12 -mr-8 sm:-mr-12"></div>
    </section>
  );
};
        ...
        <Section id="location">
            ...
            <div className="flex flex-col md:flex-row gap-8 w-full mt-4">
                <div className="flex-1 bg-white p-8 rounded-lg shadow-lg text-center text-brand-dark">
                    <h3 className="font-playfair text-3xl text-brand-gold">AKAD</h3>
                    <p className="font-lato mt-4 font-bold">Rabu, 05 November 2025</p>
                    <p className="font-lato">09:00 - 11:00 WIB</p>
                ...
                <div className="flex-1 bg-white p-8 rounded-lg shadow-lg text-center text-brand-dark">
                    ...
                    <p className="font-lato mt-4 font-bold">Rabu, 05 November 2025</p>
                    <p className="font-lato">11:00 - 15:00 WIB</p>
                    <hr className="my-4 border-brand-gold/20"/>
                    <p className="font-lato font-bold">{venue.name}</p>
                    <p className="font-lato text-sm">{venue.address}</p>
                    <a href={venue.mapsUrl} target="_blank" rel="noopener noreferrer" className="mt-6 inline-flex items-center gap-2 px-6 py-2 border border-brand-gold text-brand-gold rounded-full hover:bg-brand-gold hover:text-white transition-colors">
